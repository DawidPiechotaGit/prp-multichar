...
local function skyCam(bool)
    ...
    if bool then
        ...
        cam = CreateCamWithParams('DEFAULT_SCRIPTED_CAMERA', RandomLocation.CamCoords.x, RandomLocation.CamCoords.y, RandomLocation.CamCoords.z, -6.0, 0.0, RandomLocation.CamCoords.w, 40.0, false, 0)
...
RegisterNetEvent('qb-multicharacter:client:chooseChar', function()
    ...
    DoScreenFadeOut(10)
    Wait(1000)
    local interior = GetInteriorAtCoords(RandomLocation.PedCoords.x, RandomLocation.PedCoords.y, RandomLocation.PedCoords.z - 18.9)
    ...
    -- SetEntityCoords(PlayerPedId(), RandomLocation.PedCoords.x, RandomLocation.PedCoords.y, RandomLocation.PedCoords.z-5.0)
    SetEntityCoords(PlayerPedId(), RandomLocation.PedCoords.x+3.0, RandomLocation.PedCoords.y+3.0, RandomLocation.PedCoords.z)
        ...
        QBCore.Functions.TriggerCallback('qb-multicharacter:server:getSkin', function(skinData)
            if skinData then
                ...
                CreateThread(function()
                    ...
                    charPed = CreatePed(2, model, RandomLocation.PedCoords.x, RandomLocation.PedCoords.y, RandomLocation.PedCoords.z - 0.98, RandomLocation.PedCoords.w, false, true)
